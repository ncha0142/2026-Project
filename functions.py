...
#gensim wouldn't install so pasted its stopword list here
STOPWORDS = frozenset([
    ...
    def make_csv(folder_path, extension):
        ...
        with open('corpus.csv', 'w', encoding='UTF8', newline='') as file:
            ...
            for i in range(len(txt_lst)):
                ...
                with open(filepath, 'r', encoding='utf-8', errors='ignore') as contents:
...
class os_level:
    ...
    #The extension of the file type wanted
